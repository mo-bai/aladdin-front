  ...
  return (
    <>
      ...
      <motion.div
        ...
        <motion.div
          className="bg-[url('/svgs/home/bg3.svg')] bg-cover bg-center bg-no-repeat bg-[#c2aafa] rounded-[20px] md:rounded-[28px] lg:rounded-[32px] outline outline-1 outline-offset-[-1px] outline-[#8d75e6] overflow-hidden flex justify-center items-center h-auto md:h-[30rem] lg:h-[36.5rem]"
          variants={{
            initial: {
              opacity: 0,
